...
export default function ConfigSummary() {
    ...
    const defaultConfig = useSelector(store => store.configuration)
    ...
    return (
        <Grid container>
            <Grid item xs={6}>
                <p className={classes.bold}>{t('settings.language_config.language')}:</p>
            </Grid>
            <Grid item xs={6}>
            ...
            <Grid item xs={6}>
                <p className={classes.bold}>{t('settings.currency_config.currency')}:</p>
            </Grid>
            <Grid item xs={6}>
